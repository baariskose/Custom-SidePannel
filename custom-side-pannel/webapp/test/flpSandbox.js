		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Custom Side Pannel",
									"targetURL": "#smodsidepannelcustomsidepannel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"smodsidepannelcustomsidepannel-display": {
								"semanticObject": "smodsidepannelcustomsidepannel",
								"action": "display",
								"description": "A custom side pannel",
								"title": "Custom Side Pannel",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=smod.sidepannel.customsidepannel",
									"url": sap.ui.require.toUrl("smod/sidepannel/customsidepannel")
								}
							}
						}
					}
